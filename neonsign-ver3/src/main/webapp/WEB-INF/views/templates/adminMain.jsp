...
<table border="1" class="table table-hover">
	...
	<tbody align="center" id="serviceCenterList">
	<c:forEach items="${requestScope.adminList.serviceCenterList.serviceCenterVO}" var="list"  varStatus="i">
		<tr  id="pagetitle">
			<td>${i.index+1 }</td>
			<td><a href="${initParam.root}ServiceCenterView.neon?ServiceCenterNo=${list.serviceCenterNo}">${list.serviceCenterTitle}</a></td>
